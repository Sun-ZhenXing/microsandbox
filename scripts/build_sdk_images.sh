...
AVAILABLE_SDKS=("python" "node" "deno")
...
function show_usage {
    ...
    printf "  -s, --sdk SDK_NAME      Build specific SDK image (${YELLOW}python${NC}, ${YELLOW}node${NC}, ${YELLOW}deno${NC})\n"
    ...
    echo "  $0 -s deno              # Build only the Deno SDK image"
    echo
}
